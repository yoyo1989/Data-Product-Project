...
shinyUI(
  pageWithSidebar(
    ...
    sidebarPanel(
      ...
      withMathJax((helpText("where c=299792458.0 m/s."))),
      ...
      helpText(a(href="https://github.com/yoyo1989/Data-Product-Project", target="_blank", "View code"))
    ),
    ...
    mainPanel(
        ...
        h4('Velocity 1 (m/s, using the non-relativistic formula on the left)'),
        verbatimTextOutput("velocityCal1"),
        h4('Velocity 2 (m/s, using the relativistic formula on the left)'),
